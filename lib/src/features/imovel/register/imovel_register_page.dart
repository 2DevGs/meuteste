...
import 'package:teste_imobi_brasil/src/features/imovel/register/imovel_register_viewmodel.dart';
import 'package:validatorless/validatorless.dart';

class ImovelRegisterPage extends ConsumerStatefulWidget {
  const ImovelRegisterPage({super.key});

  @override
  ConsumerState<ImovelRegisterPage> createState() => _ImovelRegisterPageState();
}

class _ImovelRegisterPageState extends ConsumerState<ImovelRegisterPage>
    with Messages {
  ...
  Widget build(BuildContext context) {
    final imovelRegisterVM =
        ref.watch(imovelRegisterViewmodelProvider.notifier);
    ref.listen(
      imovelRegisterViewmodelProvider,
      (_, state) {
        switch (state) {
          case ImovelRegisterStateStatus.initial:
            break;
          case ImovelRegisterStateStatus.success:
            showSuccessSnackBar('Imovel cadatrado com sucesso.');
            Navigator.pop(context);
          case ImovelRegisterStateStatus.error:
            showErrorSnackBar('Erro ao registrar imóvel!');
        }
      },
    );
    return Scaffold(
                    ...
                    onPressed: () {
                      switch (_formKey.currentState?.validate()) {
                        ...
                        case true:
                          ...
                          imovelRegisterVM.registrarImovel(
                            titulo: _tituloEC.text,
